...
public class TestClassXml {
	...
	public void Test12() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "bright.xml",bright);
	...
	public void Test13() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "contrast.xml", contrast);
	...
	public void Test14() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "convert.xml", convert);
	...
	public void Test15() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "crop.xml", crop);
	...
	public void Test16() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "deskew.xml", deskew);
	...
	public void Test17() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "hierarchy.xml", hierarchy);
	...
	public void Test18() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "layout.xml", layout);
	...
	public void Test19() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "rotate.xml", rotate);
	...
	public void Test20() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "otsu.xml", otsu);
	...
	public void Test21() {
		...
		xml.generateXml(propertyHolderTest.getOutputSchemasFolder() + "tesseract.xml", tesseract);
